...
@section('content')
    ...
    <section class="__image-slider __search __checkout">
        ...
        <div class="__slider-item"
             style="background-image: url('https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?auto=format&fit=crop&w=1350&q=60&ixid=dW5zcGxhc2guY29tOzs7Ozs%3D'); opacity: 0.5;"></div>
    </section>
                                ...
                                <div class="row">
                                    ...
                                    @if($order->table_no != null)
                                        ...
                                        <div class="col-md-6">
                                            <br/><br/>
                                            <div class="payment-img"
                                                 style="background: url('{{asset('img/cash.png')}}');"></div>
                                            <br>
                            ...
                            @foreach ($carts as $key => $cart)
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;">
                                        ...
                                        <h5><input type="number" value="{{ $cart->quantity }}"
                                                   style="width: 100%; border: none;"></h5>
                                    </td>
                                    ...
                                    <tr id="note_{{ $cart->id }}">
                                        <td colspan="8">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" readonly data-plugin="text_limiter"
                                                          data-counter="#note_counter_{{ $cart->id }}" data-limit="100"
                                                          name="name"
                                                          style="width: 100%; font-size: 10px;">{{ $cart->note }}</textarea>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                            ...
                            @if ($order->discount != 0)
                                <tr>
                                    ...
                                    <td style="border-top: 1px solid #c1c1c1 !important;">
                                        ...
                                        <h3 style="margin: 0;">
                                            -{{ number_format($grandtotal*($order->discount/100), 2) }}</h3>
                                    </td>
                                </tr>
                            @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="firstname" placeholder="First Name"
                                           readonly
                                           value="{{ ucwords(strtolower(Auth::guard('u')->user()->firstname)) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="middlename" placeholder="Middle Name"
                                           readonly
                                           value="{{ ucwords(strtolower(Auth::guard('u')->user()->middlename)) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lastname" placeholder="Last Name"
                                           readonly
                                           value="{{ ucwords(strtolower(Auth::guard('u')->user()->lastname)) }}">
                                </div>
                            </div>
    ...
    <div id="__paywithCash" class="modal fade" role="dialog">
        <div class="modal-dialog">

            <!-- Modal content-->

            <form class="" action="{{ route('paymentCashProcess', [$oid, $uid, $enc]) }}" method="post">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Pay via The Craving Group Card</h4>
                    ...
                    <div class="modal-body" style="padding: 20px;">
                        ...
                        Are you sure you want to pay via Cash?


                        <input type="hidden" name="firstname" placeholder="First Name" value="{{ ucwords(strtolower(Auth::guard('u')->user()->firstname)) }}">


                        <input  type="hidden" name="middlename" placeholder="Middle Name"value="{{ ucwords(strtolower(Auth::guard('u')->user()->middlename)) }}">


                        <input type="hidden" name="lastname" placeholder="Last Name" value="{{ ucwords(strtolower(Auth::guard('u')->user()->lastname)) }}">
