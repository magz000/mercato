          ...
          <div class="modal-body">
              ...
              <form action="{{ route('createUserProcess') }}" method="post">
                  ...
                  <center>
                      <div class="btn-group" data-toggle="buttons">
                          <label class="btn btn-primary active" style="width: 150px;">
                            <input type="radio" class="radio" name="user_type" id="option2" value="1" autocomplete="off" checked>
                            <i class="fa fa-user" style="font-size: 64px;"></i><Br>
                            Buyer
                          </label>

                          <label class="btn btn-primary" style="width: 150px;">
                            <input type="radio" class="radio" name="user_type" id="option3" value="2" autocomplete="off">
                            <img src="data:image/svg+xml;utf8;base64," />
                            <Br/>
                            Provider
                          </label>
                 ...
                 <div class="row">
                     <div class="col-md-6">
                         ...
                         <div class="form_group">
                             ...
                             <input type="text" placeholder="Email" value="{{ old('semail') }}" name="semail" class="form-control">
                         </div>
                         <Br/>
                         <div class="form_group">
                         ...
                         <div class="form_group">
                             ...
                             <input type="password" placeholder="Confirm Password" name="srepassword" class="form-control">
                         </div>
                         <br/>
                     ...
                     <div class="col-md-6">
                         ...
                         <div class="form_group">
                             ...
                             <input type="text" placeholder="First Name" value="{{ old('sfirstname') }}" name="sfirstname" class="form-control">
                         </div>
                         <Br/>
                         <div class="form_group">
                             <label for="">Last Name <span style="color: red">*</span></label>
                             <input type="text" placeholder="Last Name" value="{{ old('slastname') }}" name="slastname" class="form-control">
                         </div><Br/>
                         <div class="form_group">
                             <label for="">Contact <span style="color: red">*</span></label>
                             <input type="number" placeholder="Contact Number" value="{{ old('scontact') }}" name="scontact" class="form-control">
                         </div><Br/>
                         <div class="form_group">
                             <label for="">Date of Birth <span style="color: red">*</span></label>
                             <input type="text" placeholder="Birthday" value="{{ old('sbirthday') }}" name="sbirthday" class="form-control birthday">
                         </div>
                     </div>
                 </div>
