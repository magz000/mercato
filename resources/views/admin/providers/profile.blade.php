                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="firstname" class="form-control" value="{{ $provider->firstname }}">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="">Middle Name</label>
                                            <input type="text" name="middlename" class="form-control" value="{{ $provider->middlename }}">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="">Last Name</label>
                                            <input type="text" name="lastname" class="form-control" value="{{ $provider->lastname }}">
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="">Street</label>
                                            <input type="text" name="street" value="{{ $provider->street }}" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Baranggay</label>
                                            <input type="text" name="barangay" value="{{ $provider->barangay }}" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="state" readonly value="{{ $provider->state }}" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Postal Code</label>
                                            <input type="text" name="postal_code" value="{{ $provider->postal_code }}" class="form-control">
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <select name="location[]" id="" class="form-control" multiple placeholder="Search for Location">
                                                  @foreach ($Location->all() as $location)
                                                      @php
                                                        $select = $ProviderLocation->where('provider_id','=', $provider->id)->where('location', '=', $location->id)->first();
                                                      @endphp
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label for="">Bio</label>
                                                <textarea name="bio" class="form-control" placeholder="Write someting about yourself...">{{ $provider->bio }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var vanilla = new Croppie(el, {
                url     : "{{ $provider->picture == '' ? asset('img/placeholder.jpg') : asset('img/providers/'. $provider->picture) }}",
